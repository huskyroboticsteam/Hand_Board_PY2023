...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3432u, /* Base address: 0x400F3400 Count: 50 */
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT4_BASE), 0x000000BEu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC), 0x004124B1u);
