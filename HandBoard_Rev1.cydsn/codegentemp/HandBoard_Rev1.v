// ======================================================================
// HandBoard_Rev1.v generated from TopDesign.cysch
// 04/04/2023 at 18:25
...
module ADC_SAR_SEQ_P4_v2_50_6 (
	...
	cy_psoc3_pins_v1_10
		#(.id("2ea4cae8-6b43-4be4-95d6-04d6edcceeb0/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    defparam Status_Reg_Switches.MaskValue = 7;
    defparam Status_Reg_Switches.NumInputs = 3;


    assign mywire_1[0] = ~Net_200;
    ...
    assign Net_594 = ~Net_593;


    assign Net_592 = ~Net_591;


    assign Net_590 = ~Net_589;


    assign Net_588 = ~Net_587;

	wire [0:0] tmpOE__Pin_Limit_3_net;
	wire [0:0] tmpIO_0__Pin_Limit_3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Limit_3_net;
	electrical [0:0] tmpSIOVREF__Pin_Limit_3_net;

	cy_psoc3_pins_v1_10
		#(.id("b6242ab6-ba05-4358-af2e-605b00070522"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Limit_3
		 (.oe(tmpOE__Pin_Limit_3_net),
		  .y({1'b0}),
		  .fb({Net_586}),
		  .io({tmpIO_0__Pin_Limit_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Limit_3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Limit_3_net[0:0]}),
		  .annotation({Net_585}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Limit_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign mywire_1[2] = ~Net_586;
	...
	wire [0:0] tmpOE__Pin_Motor_1_net;
	wire [0:0] tmpFB_0__Pin_Motor_1_net;
	wire [0:0] tmpIO_0__Pin_Motor_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Motor_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Motor_1_net;

	cy_psoc3_pins_v1_10
		#(.id("6455611f-1be8-498a-a38e-ce29f2384dec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Pin_Motor_1
		 (.oe(tmpOE__Pin_Motor_1_net),
		  .y({Net_1573}),
		  .fb({tmpFB_0__Pin_Motor_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Motor_1_net[0:0]}),
	...
	assign tmpOE__Pin_Motor_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Timer_PWM.DeviceFamily = "PSoC4";
    defparam Timer_PWM.InterruptOnCapture = 0;
    defparam Timer_PWM.InterruptOnTC = 1;
    defparam Timer_PWM.Resolution = 24;
    ...
    ADC_SAR_SEQ_P4_v2_50_6 ADC_SAR_Seq_1 (
        .aclk(1'b0),
        .eoc(Net_1063),
        .sdone(Net_1064),
        .soc(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7247074d-9717-44ce-ba4b-1046cb72dffb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_Encoder_A_1_net;
	wire [0:0] tmpIO_0__Pin_Encoder_A_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Encoder_A_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Encoder_A_1_net;

	cy_psoc3_pins_v1_10
		#(.id("758c555d-f24f-4b1a-aea7-6947b243da08"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Encoder_A_1
		 (.oe(tmpOE__Pin_Encoder_A_1_net),
		  .y({1'b0}),
		  .fb({Net_698}),
		  .io({tmpIO_0__Pin_Encoder_A_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Encoder_A_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Encoder_A_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Encoder_A_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4e4a5dec-2a5f-41ad-892c-9fd9bca5f5c9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("53f6c7cb-0e45-43e4-921a-04b033eca760"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_Direction_1_net;
	wire [0:0] tmpFB_0__Pin_Direction_1_net;
	wire [0:0] tmpIO_0__Pin_Direction_1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Direction_1_net;
	electrical [0:0] tmpSIOVREF__Pin_Direction_1_net;

	cy_psoc3_pins_v1_10
		#(.id("ad82ad6e-322a-4c7c-8682-35f63c06aba0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Direction_1
		 (.oe(tmpOE__Pin_Direction_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Direction_1_net[0:0]}),
		  .io({tmpIO_0__Pin_Direction_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Direction_1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Direction_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Direction_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3c816833-4fc1-4bf0-9de2-6c98465161ad"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0628f4d9-0c73-46bc-8375-fb4d6dbcd1af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("12007194-6469-4350-8ffa-913a06e48f13"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("44f608a9-74bc-4967-b065-edc8d797b8fe"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DEBUG_LED_2_net;
	wire [0:0] tmpFB_0__DEBUG_LED_2_net;
	wire [0:0] tmpIO_0__DEBUG_LED_2_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_LED_2_net;
	electrical [0:0] tmpSIOVREF__DEBUG_LED_2_net;

	cy_psoc3_pins_v1_10
		#(.id("b1670605-7250-4a33-985a-95aceb87f38f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_LED_2
		 (.oe(tmpOE__DEBUG_LED_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DEBUG_LED_2_net[0:0]}),
		  .io({tmpIO_0__DEBUG_LED_2_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_LED_2_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_LED_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_LED_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
